...
mkdir -p reports
docker compose cp mynah_ui:/home/appuser/data/artifacts/reports/quality/human-transcript-trend-report.md reports/human-transcript-trend-report.md >/dev/null
echo "host_report_path=reports/human-transcript-trend-report.md"
